...
class MovieRecommender:
    ...
    def evaluate(self):
        return self.model.evaluate(self.ratings, return_dict=True)
...
if __name__ == "__main__":
    ...
    model_path = str(model_dir / 'DNN-7-96_32-64_32-emb_0.25-cross_emb' / 'best' / 'cp-174_loss-14645_acc100-0.3109_rmse-0.9815.ckpt')
